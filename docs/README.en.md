...
Full description of every page of the program. The short overview and the quick install live in
the [README](../README.en.md) at the repository root. [🇷🇺 Русский](README.md)

| Page | About |
|---|---|
| [Installation](install.en.md) | requirements, building from source, the installer, the portable build, moving from the old name, removal |
...
| [Capture](capture.en.md) | screenshots and video by hotkeys: region selection, annotations, editor, sound, notification, gallery, import from VK Play GameCenter |
| [Overlay](overlay.en.md) | metrics on top of games and programs, lag recording, NVIDIA frame limiter |
| [Torrents](torrents.en.md) | the built-in BitTorrent client: adding, seeding, torrent updates |
